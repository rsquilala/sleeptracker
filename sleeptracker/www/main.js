...
const routes = [
    {
        path: '',
        loadChildren: () => __webpack_require__.e(/*! import() */ "src_app_tab-bar_tab-bar_module_ts").then(__webpack_require__.bind(__webpack_require__, /*! ./tab-bar/tab-bar.module */ 2361)).then(m => m.TabBarPageModule)
    }
];
